    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> CE_Login( string nextUrl )
        {
            ...
            try
            {
                ...
                nextUrl = string.IsNullOrWhiteSpace(nextUrl) ? "~/?searchtype=credential" : nextUrl;
        ...
        private void GetOrganizationsForUser( AppUser user )
        {
            ...
            try
            {
                ...
                {
                    LoggingHelper.DoTrace( 5, "AccountController.GetOrganizationsForUser. Found: " + organizationsForUserJSON );
