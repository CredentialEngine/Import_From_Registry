...
{
	/// <summary>
	/// only include properties that have to be handled due to obsolete format
	/// </summary>
    public class CredentialProxy : BaseResourceDocument
    {
		[JsonIgnore]
  ...
  //      public List<CostProfile> EstimatedCost { get; set; }
        ...
        public List<ConditionProfileOLD> Requires { get; set; }

        [JsonProperty( PropertyName = "ceterms:corequisite" )]
        public List<ConditionProfileOLD> Corequisite { get; set; }
