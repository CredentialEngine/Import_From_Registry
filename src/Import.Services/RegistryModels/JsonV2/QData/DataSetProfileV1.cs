...
namespace RA.Models.JsonV2.QData
{
	public class DataSetProfileV1
	{
		...
		/// </summary>
		[JsonProperty( PropertyName = "qdata:dataSetTimePeriodList" )]
		public List<DataSetTimeFrame> DataSetTimePeriodList { get; set; }

		[JsonProperty( PropertyName = "DataSetTimePeriod2" )]
		public List<DataSetTimeFrame> DataSetTimePeriodList2 { get; set; }
