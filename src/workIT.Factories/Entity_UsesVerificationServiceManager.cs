...
using DBEntity = workIT.Data.Tables.Entity_UsesVerificationService;
using EntityContext = workIT.Data.Tables.workITEntities;

using workIT.Models;
using MC = workIT.Models.Common;
using MP = workIT.Models.ProfileModels;
using ThisResource = workIT.Models.ProfileModels.Entity_UsesVerificationService;

namespace workIT.Factories
{
    public class Entity_UsesVerificationServiceManager : BaseFactory
    {
        static string thisClassName = "Factories.Entity_UsesVerificationServiceManager";
        ...
        /// <summary>
        /// Add an Entity_UsesVerificationService
        /// </summary>
        ...
        public int Add( MC.Entity relatedEntity, int vspId, ref SaveStatus status )
        {
            ...
            using ( var context = new EntityContext() )
            {
                ...
                try
                {
                    ...
                    efEntity = context.Entity_UsesVerificationService
                    ...
                    context.Entity_UsesVerificationService.Add( efEntity );
                ...
                {
                    string message = HandleDBValidationError( dbex, thisClassName + ".Add() ", "Entity_UsesVerificationService" );
        ...
        public static List<MP.VerificationServiceProfile> GetAll( MC.Entity parent )
        {
            ...
            try
            {
                using ( var context = new EntityContext() )
                {
                    var results = context.Entity_UsesVerificationService
                    ...
                    if ( results != null && results.Count > 0 )
                    {
                        ...
                        {
                            //TODO - do we really only care about the vsp, and not the Entity_UsesVerificationService content? Perhaps user and created for edit or detail view?
        ...
        public bool DeleteAll( int verificationServiceId, ref List<string> messages )
        {
            ...
            try
            {
                using ( var context = new EntityContext() )
                {
                    ...
                    {
                        context.Entity_UsesVerificationService.Remove( item );
                        count = context.SaveChanges();
                        if ( count > 0 )
                        {
