...
namespace workIT.Factories
{
    public class BaseFactory
    {
        ...
        public static AgentRelationshipResult Fill_AgentRelationship( List<IndexQualityAssurance> list, int categoryId, bool hasSchemaName, bool hasTotals, bool hasAnIdentifer = true, string entityType = "" )
        {
            AgentRelationshipResult item = new AgentRelationshipResult() { CategoryId = categoryId };
            item.HasAnIdentifer = hasAnIdentifer;
            AgentRelationship code = new AgentRelationship();
