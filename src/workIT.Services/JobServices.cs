...
namespace workIT.Services
{
	...
	{
        static string thisClassName = "JobServices";
        public static string ThisEntityType = "Job";
        public static int ThisEntityTypeId = CodesManager.ENTITY_TYPE_JOB_PROFILE;
        static string usingElasticSearch = "usingElasticJobSearch";
		...
		public bool Import( ThisResource resource, ref SaveStatus status )
		{
			...
			if ( resource.Id > 0 )
			{
                ...
                new SearchPendingReindexManager().Add( CodesManager.ENTITY_TYPE_JOB_PROFILE, resource.Id, 1, ref messages );
