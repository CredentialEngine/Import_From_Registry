...
namespace workIT.Services
{
	...
	{
        static string thisClassName = "OccupationServices";
        public static string ThisEntityType = "Occupation";
        public static int ThisEntityTypeId = CodesManager.ENTITY_TYPE_OCCUPATIONS_PROFILE;
        static string usingElasticSearch = "usingElasticOccupationSearch";
