...
using EntityMgr = workIT.Factories.WorkRoleManager;
...
namespace workIT.Services
{
	...
	{
		string thisClassName = "WorkRoleServices";
		...
		#region WorkRole Profile

		public static ThisEntity GetDetail( int profileId )
		{
			var profile = WorkRoleManager.GetForDetail( profileId );
		...
		{
			var profile = WorkRoleManager.GetBasic( profileId );
		...
		{
			var list = WorkRoleManager.Search( filter, "", pageNumber, pageSize, ref pTotalRows );
			return list;
		}
