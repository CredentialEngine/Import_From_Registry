...
/****** Object:  StoredProcedure [dbo].[ConditionManifest_Search]    Script Date: 10/21/2017 3:41:02 PM ******/
SET ANSI_NULLS ON
GO
...
EXECUTE @RC = [ConditionManifest_Search]
...
/* =============================================
Description:      ConditionManifests search
Options:
...
CREATE PROCEDURE [dbo].[ConditionManifest_Search]
		@Filter           varchar(5000)
...
From #tempWorkTable work
	Inner join [ConditionManifest] base on work.Id = base.Id

WHERE RowNumber > @first_id
order by RowNumber 
go
grant execute on [ConditionManifest_Search] to public
