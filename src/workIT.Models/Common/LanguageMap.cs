...
namespace workIT.Models.Common
{
    ...
    [Serializable]
    public class EntityLanguageMap
    {
        ...
        public string LanguageMapListString { get; set; } = "";
        public LanguageMap LanguageMap { get; set; } = new LanguageMap();
        public LanguageMapList LanguageMapList { get; set; } = new LanguageMapList();
    }
}
