...
namespace workIT.Models.QData
{
	...
	public class DataProfile
	{
		...
		/// </summary>
		public Enumeration AdministrativeRecordType { get; set; }
		//public List<string> AdministrativeRecordTypeList { get; set; } 
		/// <summary>
		...
		/// </summary>
		public Enumeration IncomeDeterminationType { get; set; } 
